...
class ActivitySelfDevEditorPage extends StatefulWidget {
  final String groupId;
  final String meetingId;

  const ActivitySelfDevEditorPage({
    super.key,
  ...
  @override
  State<ActivitySelfDevEditorPage> createState() =>
      _ActivitySelfDevEditorPageState();
}

class _ActivitySelfDevEditorPageState
    extends State<ActivitySelfDevEditorPage> {
  ...
  Future<void> _publish() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Catatan dipublish.')),
      );
    } catch (e) {
      if (!mounted) return;
  ...
  Future<void> _deleteDraft() async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Draft akan dihapus.'),
        actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tulis Pengembangan Diri'),
        actions: [
          TextButton(
            ...
            Expanded(
              child: TextField(
                ...
                decoration: const InputDecoration(
                  hintText: 'Tulis pengembangan diri di sini...',
